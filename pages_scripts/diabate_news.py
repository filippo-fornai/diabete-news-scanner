...
url = 'https://www.diabete.com/diabete/terapia/'

def diabete_news(driver):
    news_number = int(os.getenv('DIABETE_NEWS_NUMBER', 5))
    driver.get(url)

    # selector = '#cmplz-cookiebanner-container > div > div.cmplz-buttons > button.cmplz-btn.cmplz-deny'
